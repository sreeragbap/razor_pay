...
class SplashMobilePage extends StatelessWidget {
  const SplashMobilePage({Key? key}) : super(key: key);
          ...
          either.fold(
            ...
            (success) {
              ...
              context.read<LoginBloc>().add(LoginEvent.saveSplashToken(
                  ...
                  context.read<RegistrationBloc>().add(RegistrationEvent.saveSplashToken(splashToken:state.splashModel!.splashToken ));
                  context.read<OtpVerificationBloc>().add(OtpVerificationEvent.saveSplashToken(splashToken: state.splashModel!.splashToken));
                  context.read<ForgotpasswordBloc>().add(ForgotpasswordEvent.saveSplashToken(splashToken: state.splashModel!.splashToken));
