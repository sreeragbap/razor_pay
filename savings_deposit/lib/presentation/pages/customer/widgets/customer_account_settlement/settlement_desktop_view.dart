    ...
    return BlocConsumer<CustomerBloc, CustomerState>(
      ...
      state.settlementFailureOrSuccess.fold(
        ...
        (a) => a.fold(
          (l) {
            l.map(
              clientFailure: (_) => ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    ...
                    children: [
                      ...
                      Text(
                        delegate.settlementAccountNumber +
                            " : " +
                            customerSettlement.accountNumber.toString(),
                        style: TextStyle(fontSize: ismalayalam ? 12 : 15),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      Text(
                        delegate.settlementInterestRate +
                            " : " +
                            customerSettlement.intrestRate.toString() +
                            '%',
                        style: TextStyle(fontSize: ismalayalam ? 12 : 15),
                      ),
                      kHeight5,
                      Text(
                        delegate.settlementRoundingDifference +
                            ":" +
                            toRupeeFormat(
                                customerSettlement.roundindDifference!),
                        style: TextStyle(fontSize: ismalayalam ? 12 : 15),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      Text(
                        delegate.settlementBalance +
                            " : " +
                            toRupeeFormat(customerSettlement.balance!),
                        style: TextStyle(fontSize: ismalayalam ? 12 : 15),
                      ),
                      kHeight5,
                      Text(
                        delegate.settlementTotalInterest +
                            " : " +
                            toRupeeFormat(customerSettlement.interest!),
                        style: TextStyle(fontSize: ismalayalam ? 12 : 15),
                      ),
                    ],
                  ),
                          ...
                          Checkbox(
                            onChanged: (val) {
                              context.read<CustomerBloc>().add(
                                  CustomerEvent.checkboxSelectedCash(
                        ...
                        children: [
                          Text(
                            delegate.settlementSettleAmount +
                                ':  ₹ ' +
                                toRupeeFormat(customerSettlement.settleAmount!),
                            style: TextStyle(fontSize: ismalayalam ? 12 : 15),
                          )
                        ],
                      ),
