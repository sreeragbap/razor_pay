...
/// @nodoc
class _$DepositFailureTearOff {
  const _$DepositFailureTearOff();

  _ChequeNumberValidOrNot chequeNumberValidOrNot() {
    return const _ChequeNumberValidOrNot();
  }
...
/// @nodoc
const $DepositFailure = _$DepositFailureTearOff();

/// @nodoc
mixin _$DepositFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $DepositFailureCopyWith<$Res> {
  factory $DepositFailureCopyWith(
          DepositFailure value, $Res Function(DepositFailure) then) =
      _$DepositFailureCopyWithImpl<$Res>;
}

/// @nodoc
class _$DepositFailureCopyWithImpl<$Res>
    implements $DepositFailureCopyWith<$Res> {
  _$DepositFailureCopyWithImpl(this._value, this._then);

  final DepositFailure _value;
  // ignore: unused_field
  final $Res Function(DepositFailure) _then;
}

/// @nodoc
abstract class _$ChequeNumberValidOrNotCopyWith<$Res> {
  factory _$ChequeNumberValidOrNotCopyWith(_ChequeNumberValidOrNot value,
          $Res Function(_ChequeNumberValidOrNot) then) =
      __$ChequeNumberValidOrNotCopyWithImpl<$Res>;
}

/// @nodoc
class __$ChequeNumberValidOrNotCopyWithImpl<$Res>
    extends _$DepositFailureCopyWithImpl<$Res>
    implements _$ChequeNumberValidOrNotCopyWith<$Res> {
  __$ChequeNumberValidOrNotCopyWithImpl(_ChequeNumberValidOrNot _value,
      $Res Function(_ChequeNumberValidOrNot) _then)
      : super(_value, (v) => _then(v as _ChequeNumberValidOrNot));

  @override
  _ChequeNumberValidOrNot get _value => super._value as _ChequeNumberValidOrNot;
}
...
class _$_ChequeNumberValidOrNot implements _ChequeNumberValidOrNot {
  ...
  @override
  String toString() {
    return 'DepositFailure.chequeNumberValidOrNot()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ChequeNumberValidOrNot);
  }
...
abstract class _ChequeNumberValidOrNot implements DepositFailure {
...
class _$_ClientFailure implements _ClientFailure {
  ...
  @override
  String toString() {
    return 'DepositFailure.clientFailure()';
  }
...
abstract class _ClientFailure implements DepositFailure {
...
class _$_ServerFailure implements _ServerFailure {
  ...
  @override
  String toString() {
    return 'DepositFailure.serverFailure()';
  }
...
abstract class _ServerFailure implements DepositFailure {
